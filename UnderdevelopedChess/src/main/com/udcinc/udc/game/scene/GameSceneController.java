...
import main.com.udcinc.udc.game.mode.challenge.ChallengeVictoryController;
...
public class GameSceneController {
	...
	//Added code, meant to help with the ChallengeSceneController
	@FXML
    public void handleVictory(ActionEvent event) throws IOException {
		System.out.println("This text is not meant to be accessable from here");
    }
